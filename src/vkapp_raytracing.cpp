...
void VkApp::CmdCopyImage(ImageWrap& src, ImageWrap& dst)
{
    ...
    imageLayoutBarrier(m_currentCommandBuffer, src.image,
                       VK_IMAGE_LAYOUT_GENERAL, VK_ACCESS_NONE,
                       VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, VK_ACCESS_TRANSFER_READ_BIT);
    imageLayoutBarrier(m_currentCommandBuffer, dst.image,
                       VK_IMAGE_LAYOUT_GENERAL, VK_ACCESS_NONE,
                       VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_ACCESS_TRANSFER_WRITE_BIT);
    
    vkCmdCopyImage(m_currentCommandBuffer,
...
void VkApp::raytrace()
{
    ...
    vkCmdBindPipeline(m_currentCommandBuffer, VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR, m_rtPipeline);
    ...
    vkCmdBindDescriptorSets(m_currentCommandBuffer, VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR,
                            m_rtPipelineLayout, 0,
                            descSets.size(), descSets.data(),
                            0, nullptr);

    // Push the push constants
    vkCmdPushConstants(m_currentCommandBuffer, m_rtPipelineLayout,
                       VK_SHADER_STAGE_RAYGEN_BIT_KHR
                       | VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR
    ...
    vkCmdTraceRaysKHR(m_currentCommandBuffer, &m_rgenRegion, &m_missRegion, &m_hitRegion,
