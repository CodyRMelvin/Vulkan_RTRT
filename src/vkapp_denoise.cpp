...
void VkApp::denoise()
{
    ...
    vkCmdPipelineBarrier(m_currentCommandBuffer, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
    ...
    for (int a=0; a<m_num_atrous_iterations; a++) {
        ...
        vkCmdBindPipeline(m_currentCommandBuffer, VK_PIPELINE_BIND_POINT_COMPUTE, m_denoisePipeline);
        ...
        vkCmdPushConstants(m_currentCommandBuffer, m_denoiseCompPipelineLayout,
        ...
        vkCmdDispatch(m_currentCommandBuffer,
